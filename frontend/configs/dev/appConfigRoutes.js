  ...
  kpiCard: (kpiFamilyOptions, kpiGroupOptions, kpi, addCharts, addKpiCard, forceNational = false) => {
    let kpicard = {
      ...
      settings: {
        ...
        containerClass: `borders-y-only mt-0 mb-${addCharts? 0 : 0 } mx-5 kpi-block-carto-${addCharts? 'center' : 'bottom' }`,
        containerClassMobile: `borders-y-only mt-0 mb-${addCharts? 0 : 0 } mx-4 kpi-block-carto-${addCharts? 'center' : 'bottom' }-mobile`,
