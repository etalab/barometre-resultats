...
export const state = () => ({
  ...
  defaultOdamapHeight: 890,
  triggerComponentsLoaded: 1,
  componentsLoaded: {}
})
...
export const getters = {
  ...
  getUserRouteParams: (state) => {
    return state.userRouteParams
  },
  ...
  getDivCurrentVisibility: (state, getters) => (div) => {
    // state.log && console.log("\nS-index-G-getDivCurrentVisibility / div : ", div )
    try {
  ...
  getDataViewConfig: (state) => ({ dataViewType, id }) => {
    ...
    // state.log && console.log("S-index-G-getDataViewConfig / state.configsData : ", state.configsData)
...
export const mutations = {
  ...
  setRootConfigs (state, configs) {
    ...
    const configsData = {
      ...
      kpitables: configs.KPITABLES_config.settingsIds,
  ...
  setRouteLoading (state, val) {
    state.isRouteLoading = val
  },
  setUserRouteParams (state, val) {
    state.userRouteParams = val
  },

  // DIVS VISIBILITY
  setDivVisibility (state, divRef) {
    // state.log && console.log("\nS-index-M-setDivVisibility / divRef : ", divRef)
    // state.log && console.log("S-index-M-setDivVisibility / state.divsVisibility - A : ", state.divsVisibility)
    ...
    if (divIdx > -1) {
      // state.log && console.log("S-index-M-setDivVisibility / divIdx > -1 ")
    ...
    // state.log && console.log("S-index-M-setDivVisibility / state.divsVisibility - B : ", state.divsVisibility)
  },
  ...
  // INNTERNAL UTILS
  toggleTriggerComponentLoaded (state) {
    state.triggerComponentsLoaded = state.triggerComponentsLoaded * -1
  },
  setComponentLoaded (state, component) {
    state.componentsLoaded[component.id] = { loaded: component.loaded }
  }
}
...
export const actions = {
  ...
  toggleDivsVisibility ({ state, getters, commit }, btnConfig) {
    for (const divsToToggle of btnConfig.divsToToggle) {
      // state.log && console.log('\nS-index-A-toggleDivsVisibility / divsToToggle : ', divsToToggle)
      ...
      for (const div of divsToToggle.divIds) {
        ...
        // state.log && console.log('S-index-A-toggleDivsVisibility / isDiv : ', isDiv)
        ...
        // state.log && console.log('S-index-A-toggleDivsVisibility / divRef : ', divRef)
        commit('setDivVisibility', divRef)
      }
    }
  },
  updateUserRouteParams ({ commit }, userParams) {
    commit('setUserRouteParams', userParams)
  }
}
