...
export const getters = {
  ...
  getFromSpecialStoreData: (state) => (params) => {
    // state.log && console.log("\nS-data-A-getFromSpecialStoreData / params  : ", params )
    // state.log && console.log("S-data-A-getFromSpecialStoreData / state.specialStore  : ", state.specialStore )
  ...
  getStoreSourceData: (state, getters) => (params) => {
    // state.log && console.log("S-data-G-getStoreSourceData ... params.fromDatasetId : ", params.fromDatasetId)
    // state.log && console.log("S-data-G-getStoreSourceData ... params : ", params)
    let data
    ...
    if (params.fromStoreData === 'specialStore') {
      // state.log && console.log("S-data-G-getStoreSourceData ... state.specialStore : ", state.specialStore)
      data = state.specialStore[fromId]
    }
    if (params.fromStoreData === 'raw') {
    ...
    if (Array.isArray(data)) {
      ...
      // state.log && console.log("S-data-G-getStoreSourceData ... array - data (2a) : ", data)
    } else {
      data = fromDatasetKey ? data[fromDatasetKey] : data
      // state.log && console.log("S-data-G-getStoreSourceData ... not array - data (2a) : ", data)
      // state.log && console.log("S-data-G-getStoreSourceData ... not array - itemKey (2a) : ", itemKey)
      data = itemKey ? data[itemKey] : data
      // state.log && console.log("S-data-G-getStoreSourceData ... not array - data (2b) : ", data)
    }
...
export const actions = {
  ...
  resetStore ({ state, getters, commit, dispatch }, params) {
    // state.log && console.log("\nS-data-A-resetStore / ...")
    // state.log && console.log("S-data-A-resetStore / params :", params)

    for (const targetParams of params.targets) {
      // state.log && console.log("\nS-data-A-resetStore / targetParams :", targetParams)
